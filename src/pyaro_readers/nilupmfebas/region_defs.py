...
_AEROCOM_DEFS = {
    ...
    "AUSTRALIA": {
        "lat_range": [-50, -10],
        "lon_range": [110, 155],
        "lon_range_plot": [90, 180],
    },
    "CHINA": {
        "lat_range": [20, 50],
        "lon_range": [90, 130],
        "lon_range_plot": [90, 140],
    },
    "EUROPE": {
        "lat_range": [40, 72],
        "lon_range": [-10, 40],
    ...
    "SAMERICA": {
        "lat_range": [-60, 20],
        "lon_range": [-105, -30],
        "lon_range_plot": [-105, -30],
    },
    "NAMERICA": {
        "lat_range": [20, 80],
        "lon_range": [-150, -45],
        "lon_range_plot": [-150, -45],
    },
}

_HTAP_DEFS = {
    "PAN": {
        "lat_range": [-54.74999999999966, 11.550000000000823],
        "lon_range": [112, -134],
    },
    "EAS": {
    ...
    "LAND": {
        "lat_range": [-59.449999999999726, 71.15000000000109],
        "lon_range": [-180, 180],
    },
    "SAS": {
    ...
    "OCN": {
        "lat_range": [-59.94999999999973, 66.25000000000136],
        "lon_range": [-180, 180],
    },
    "SEA": {
    ...
    "RBU": {
        "lat_range": [29.450000000000998, 66.25000000000136],
        "lon_range": [22, -170],
    },
    "EEUROPE": {
    ...
    "NAM": {
        "lat_range": [18.95000000000085, 71.15000000000109],
        "lon_range": [172, -52],
    },
    "WEUROPE": {
